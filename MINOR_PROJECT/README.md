...
<p align="center"><em>Figure 3: This is my IAM Dashboard showing security recommendations, resources, users, roles and policies.</em></p>
...
<p align="center"><em>Figure 4: Image resizing role. This enabled the Lambda function to retrieve images from the source bucket and upload resized images to the destination bucket.</em></p>

* IT HAS TWO IMPORTANT PERMISSION POLICIES OF S3 ACCESS AND LAMBDA ROLE.

* LAMBDA FUNCTION ASSUMES ROLES FROM HERE.
...
<p align="center"><em>Figure 5: CloudWatch Policy.</em></p>

* THIS POLICY PERMISSION ALLOWED CLOUDWATCH TO READ AND WRITE LOGS.
---
...
<p align="center"><em>Figure 6: EventBridge Policy.</em></p>

* THIS ALLOWED LAMBDA PERMISSIONS INVOKED BY EVENTBRIDGE.
---
...
<p align="center"><em>Figure 7: I configured IAM roles for Lambda execution and EventBridge invocation. The Lambda execution role allowed the function to read objects from the source S3 bucket and write resized images to the destination bucket. EventBridge used an invocation role to trigger the Lambda function when an S3 object creation event occurred.</em></p>

* THIS ALSO INCLUDES SOME OF THE ROLES GENERATED BY AWS.


* image-resizer-function-role-pyvfdrzs

#### LAMBDA SSUMES ROLE FROM HERE.

* lambda-image-resizer

#### AWS CONSOLE RULE FOR EXECUTION.

* Amazon_EventBridge_Invoke_Lambda_1971008099

#### EVENTBRIDGE GOT POWER TO INVOKE LAMBDA.
...
<p align="center"><em>Figure 8: POLICIES INCLUDING LAMBDA ACCESS TO OTHER SERVICES AND EVENTBRIDGE GOT ACCESS TO LAMBDA INVOKING.</em></p>
...
<p align="center"><em>Figure 9: AWS Lambda dashboard which shows functions, layers, resources and other metrices.</em></p>
...
<p align="center">
  <img src="https://github.com/manvendrasinghmaheep-codes/LAUNCHED_GLOBAL_CLOUD_COMPUTING_INTERNSHIP_2026/blob/main/MINOR_PROJECT/MINOR_SCREEENSHOTS/Lambda%20Diagram.png" width="800"/>
</p>

<p align="center"><em>Figure 10: AWS Lambda shows connection between S3 and lambda function with pillow layer attached.</em></p>


* OUR FUNCTION GETS TRIGGERED BY EVENTBRIDGE RECIEVES S3 OBJECT CREATED EVENT USING PILLOW LAYER IT RESIZES AND SEND TO S3 RESIZED BUCKET.

* THE CODE IS PROVIDED IN THE CODE SECTION.

---

<p align="center">
  <img src="https://github.com/manvendrasinghmaheep-codes/LAUNCHED_GLOBAL_CLOUD_COMPUTING_INTERNSHIP_2026/blob/main/MINOR_PROJECT/MINOR_SCREEENSHOTS/Lambda%20General%20Configuration.png" width="800"/>
</p>

<p align="center"><em>Figure 11: AWS Lambda General configuration.</em></p>

* HERE THE TIMEOUT HAS BEEN INCREASED TO 30 SECONDS TO DEAL WITH IMAGE PROCESSING LATENCY.
...
<p align="center"><em>Figure 12: AWS Lambda code resizing function code which is the brain of whole project.</em></p>

---

<p align="center">
  <img src="https://github.com/manvendrasinghmaheep-codes/LAUNCHED_GLOBAL_CLOUD_COMPUTING_INTERNSHIP_2026/blob/main/MINOR_PROJECT/MINOR_SCREEENSHOTS/Lambda%20Trigger.png" width="800"/>
</p>

<p align="center"><em>Figure 13: AWS Lambda gets triggered when an object is created in original bucket</em></p>
...
<p align="center"><em>Figure 14: AWS Lambda image resizer code continued.. .</em></p>
...
<p align="center"><em>Figure 15: AWS Lambda test code to check working of my function. Its log is attached in screenshot folder of this project.</em></p>
...
<p align="center"><em>Figure 16: AWS Lambda permissions tab which ensures it is connected to CLOUDWATCH and S3.</em></p>
...
<p align="center">
  <img src="https://github.com/manvendrasinghmaheep-codes/LAUNCHED_GLOBAL_CLOUD_COMPUTING_INTERNSHIP_2026/blob/main/MINOR_PROJECT/MINOR_SCREEENSHOTS/Pillow%20Layer.png" width="800"/>
</p>

<p align="center"><em>Figure 17: Pillow layer inside lambda function.</em></p>

### Pillow Actual Work -

* Pillow is a Python image processing library hai.
...
* ##### IT IS BASICALLY LAYER EXTERNAL LIBRARY PACKAGE. SYSTEM AUTOMATICALLY LOADS PILLOW LIBRARY WHEN LAMBDA IN INVOKED.
...
<p align="center"><em>Figure 18: EventBridge Dashboard showing resources, metrices along with created rules and groups.</em></p>
...
<p align="center"><em>Figure 19: This is the default EventBus page.</em></p>
...
<p align="center"><em>Figure 20: This is important trigger page of my event which show target to lambda function.</em></p>
...
<p align="center"><em>Figure 21: This is important event pattern section. The rule filters events where the source is Amazon S3 and the detail type is Object Created. When the condition matches, the event triggers the Lambda function which processes the uploaded image.”</em></p>
...
<p align="center"><em>Figure 22: The default EventBus successfully shows enabled status to my event.</em></p>
...
<p align="center">
  <img src="https://github.com/manvendrasinghmaheep-codes/LAUNCHED_GLOBAL_CLOUD_COMPUTING_INTERNSHIP_2026/blob/main/MINOR_PROJECT/MINOR_SCREEENSHOTS/Original%20bucket.png" width="800"/>
</p>

<p align="center"><em>Figure 23: This was my original bucket. Here 2404271.jpg is our test case image.</em></p>


---

<p align="center">
  <img src="https://github.com/manvendrasinghmaheep-codes/LAUNCHED_GLOBAL_CLOUD_COMPUTING_INTERNSHIP_2026/blob/main/MINOR_PROJECT/MINOR_SCREEENSHOTS/Original%202404271.jpg.png" width="800"/>
</p>

<p align="center"><em>Figure 24: It is the test case image from original bucket.</em></p>
...
* Amazon S3 (manvendra-original)

        ↓
 
* S3 Event Trigger via EventBridge

        ↓
  
* AWS Lambda via IAM permissions
...
<p align="center">
  <img src="https://github.com/manvendrasinghmaheep-codes/LAUNCHED_GLOBAL_CLOUD_COMPUTING_INTERNSHIP_2026/blob/main/MINOR_PROJECT/MINOR_SCREEENSHOTS/Resize%20bucket.png" width="800"/>
</p>

<p align="center"><em>Figure 25: After going through desired pipeline our image reached resized bucket.</em></p>


---

<p align="center">
  <img src="https://github.com/manvendrasinghmaheep-codes/LAUNCHED_GLOBAL_CLOUD_COMPUTING_INTERNSHIP_2026/blob/main/MINOR_PROJECT/MINOR_SCREEENSHOTS/Resized%202404271.jpg.png" width="800"/>
</p>

<p align="center"><em>Figure 26: This is what resized iamge looks like. :) </em></p>
...
* boto3 → AWS services access
* PIL → image processing

* #### Step 2 — S3 client create -

* s3 = boto3.client('s3')

-> Meaning:

* Lambda → S3 API access

* #### Step 3 — Take bucket name from event -

* bucket = event['Records'][0]['s3']['bucket']['name']

* It identifies with the help of event data.

-> Example event:

* manvendra-original

* #### Step 4 — Bring Image key -
...
* Original image → 200x200 pixels

* #### Step 8 — Memory buffer storage -

* buffer = io.BytesIO()

* Temporary memory storage.

* #### Step 9 — New file name -
...
* #### Step 10 — Destination bucket upload -
...
## CLOUDWATCH IMPORTANCE

<p align="center">
  <img src="https://github.com/manvendrasinghmaheep-codes/LAUNCHED_GLOBAL_CLOUD_COMPUTING_INTERNSHIP_2026/blob/main/MINOR_PROJECT/MINOR_SCREEENSHOTS/CloudWatch%20Log%20Group.png" width="800"/>
</p>

<p align="center"><em>Figure 27: CLOUDWATCH LOG GROUP RELATED TO LAMBDA IMAGE RESIZE FUNCTION.</em></p>

* NOW WHENEVER MY AWS LAMBDA WORK IT AUTOMATICALLY WRITE LOGS FOR IT.

---

##### LOGS ARE TYPICALLY LIKE THIS -
...
<p align="center">
  <img src="https://github.com/manvendrasinghmaheep-codes/LAUNCHED_GLOBAL_CLOUD_COMPUTING_INTERNSHIP_2026/blob/main/MINOR_PROJECT/MINOR_SCREEENSHOTS/CloudWatch%20Log%20Stream.png" width="800"/>
</p>

<p align="center"><em>Figure 28: CLOUDWATCH LOGS STREAM WHICH ARE IMPORTANT FOR ERRORS AND DEBUGGING.</em></p>
...
* ERROR ImportModuleError

* END RequestId

* REPORT Duration: 120 ms

* ### THESE PARAMETERS ARE HELPFUL TO DETERMINE THE REASON FOR CODE CRASH. I TOO FACED MANY ERRORS ESPECIALLY RELATED TO LIBRARY. HERE ARE EXACT ERRORS AND HOW THEY WERE RESOLVED AFTERWARDS.

<p align="center">
  <img src="https://github.com/manvendrasinghmaheep-codes/LAUNCHED_GLOBAL_CLOUD_COMPUTING_INTERNSHIP_2026/blob/main/MINOR_PROJECT/MINOR_SCREEENSHOTS/Error%20Log%201.png" width="800"/>
</p>

<p align="center"><em>Figure 29: CLOUDWATCH LOGS ALSO HELPS IN MONITORING LAMBDA PERFORMANCE. These are list of errors faced during my project due to code error in function.</em></p>

---

<p align="center">
  <img src="https://github.com/manvendrasinghmaheep-codes/LAUNCHED_GLOBAL_CLOUD_COMPUTING_INTERNSHIP_2026/blob/main/MINOR_PROJECT/MINOR_SCREEENSHOTS/Error%20Log%202.png" width="800"/>
</p>

<p align="center"><em>Figure 30: CLOUDWATCH LOGS ALSO PROVIDES LATENCY, MEMORY USAGE AND EXECUTION INFORMATION.</em></p>
...
#### 2️. Event Structure Error -

* KeyError: 'Records'

-> Reason:

* Test event wrong format.

Solution:

* Correct S3 event structure.
