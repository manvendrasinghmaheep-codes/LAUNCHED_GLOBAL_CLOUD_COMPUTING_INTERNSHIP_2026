...
<p align="center"><em>Figure 2: Image resizing role. This enabled the Lambda function to retrieve images from the source bucket and upload resized images to the destination bucket.</em></p>
...
<p align="center"><em>Figure 2: I configured IAM roles for Lambda execution and EventBridge invocation. The Lambda execution role allowed the function to read objects from the source S3 bucket and write resized images to the destination bucket. EventBridge used an invocation role to trigger the Lambda function when an S3 object creation event occurred.</em></p>
...
<p align="center"><em>Figure 2: POLICIES INCLUDING LAMBDA ACCESS TO OTHER SERVICES AND EVENTBRIDGE GOT ACCESS TO LAMBDA INVOKING.</em></p>
...
<p align="center"><em>Figure 2: AWS Lambda shows connection between S3 and lambda function with pillow layer attached.</em></p>
...
<p align="center"><em>Figure 2: AWS Lambda General configuration.</em></p>
...
<p align="center"><em>Figure 2: AWS Lambda gets triggered when an object is created in original bucket</em></p>
...
<p align="center"><em>Figure 2: CLOUDWATCH LOG GROUP RELATED TO LAMBDA IMAGE RESIZE FUNCTION.</em></p>
...
<p align="center"><em>Figure 2: CLOUDWATCH LOGS STREAM WHICH ARE IMPORTANT FOR ERRORS AND DEBUGGING.</em></p>
...
<p align="center"><em>Figure 2: CLOUDWATCH LOGS ALSO HELPS IN MONITORING LAMBDA PERFORMANCE. These are list of errors faced during my project due to code error in function.</em></p>
...
<p align="center"><em>Figure 2: CLOUDWATCH LOGS ALSO PROVIDES LATENCY, MEMORY USAGE AND EXECUTION INFORMATION.</em></p>
